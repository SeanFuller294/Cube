...
namespace ConsoleAdventure.Project.Models
{
  public class Game : IGame
  {
    ...
    public void Setup()
    {
      ...
      Room room8 = new Room("room8", "An inch of water covers the floor. You don't like it here.", false);
      ...
      Room room13 = new Room("room13", "The walls are mirrored, you see your grimy reflection in every surface.", false);
      Room room14 = new Room("room14", trapString(), true);
      Room room15 = new Room("room15", "A toaster stands alone in the middle of the room. You feel the need to climb on top of it.", false);
      Room room16 = new Room("room16", "You look around and see a liquid dripping down the walls. The room smells musty. You don't like it here.", false);
      ...
      Room room24 = new Room("room24", "There is a cake in the middle of the room. You try to reach for it, but your hands go through. The cake is a lie.", false);
      Room room25 = new Room("room25", "A bright red and yellow warning light flashes over and over.", false);
